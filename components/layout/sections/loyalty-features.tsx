...
export const LoyaltyFeatures = () => {
  const features = [
    {
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 288 512" fill="currentColor">
    ...
    },
    {
      ...
      title: "Deep Link",
      description: "Display your loyalty program wherever you need it"
    },
    {
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 512 512" fill="currentColor">
      ...
      description: "An easy alternative for customers to view and redeem their rewards"
    }
  ];
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold">
                Do more with your<br />loyalty program
              </h2>
